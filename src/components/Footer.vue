<template>
    <div class="w-full h-full flex flex-col min-w-0 max-w-full">
        ...
        <div class="w-full h-[70px] flex flex-col justify-center items-center space-y-2 text-sm">
            <p class="text-white font-playfair">Saint Delaray Street 52872</p>
            <p class="text-white font-playfair">+44 810 251 50 20</p>
        </div>
